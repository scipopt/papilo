...
main( int argc, char* argv[] )
{
   ...
   // TODO: find apt. dual sol later!
   Solution<double> dual_sol = generate_random_solution( problem );
   Vec<double> primal_sol;

   VolumeAlgorithm<double> volumeAlgo{ msg, num };
   primal_sol = volumeAlgo.volume_algorithm( probUpdate.getProblem(), dual_sol );
