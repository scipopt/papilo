...
flugpl()
{
   ...
   Vec<std::tuple<int, int, double>> entries{
       { 0, 0, 1.0 },      { 1, 0, 150.0 },    { 1, 1, -100.0 },
       { 1, 2, 1.0 },      { 2, 0, -20.0 },    { 2, 2, 1.0 },
       { 3, 0, 0.9 },      { 3, 1, 1.0 },      { 3, 3, -1.0 },
       { 4, 3, 150.0 },    { 4, 4, -100.0 },   { 4, 5, 1.0 },
       { 5, 3, -20.0 },    { 5, 5, 1.0 },      { 6, 3, 0.9 },
       { 6, 4, 1.0 },      { 6, 6, -1.0 },     { 7, 6, 150.0 },
       { 7, 7, -100.0 },   { 7, 8, 1.0 },      { 8, 6, -20.0 },
       { 8, 8, 1.0 },      { 9, 6, 0.9 },      { 9, 7, 1.0 },
       { 9, 9, -1.0 },     { 10, 9, 150.0 },   { 10, 10, -100.0 },
       { 10, 11, 1.0 },    { 11, 9, -20.0 },   { 11, 11, 1.0 },
       { 12, 9, 0.9 },     { 12, 10, 1.0 },    { 12, 12, -1.0 },
       { 13, 12, 150.0 },  { 13, 13, -100.0 }, { 13, 14, 1.0 },
       { 14, 12, -20.0 },  { 14, 14, 1.0 },    { 15, 12, 0.9 },
       { 15, 13, 1.0 },    { 15, 15, -1.0 },   { 16, 15, 150.0 },
       { 16, 16, -100.0 }, { 16, 17, 1.0 },    { 17, 15, -20.0 },
       { 17, 17, 1.0 },
   };
