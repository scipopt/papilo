...
TEST_CASE( "trivial-presolve-empty-row", "[core]" )
{
   ...
   int cause = -1;
   status = dualInfer.execute( problem, problemUpdate, num, reductions, timer, cause );
   REQUIRE( status == PresolveStatus::kUnchanged );
}
